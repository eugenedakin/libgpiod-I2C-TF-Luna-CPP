...
7. 	Create the TF-Luna example program in a terminal with: g++ TFLunaCPP26.cpp -o TFLunaCPP26 `wx-config –cxxflags –libs`
8. 	Run the program with: ./TFLunaCPP26.cpp
